              ...
              >
                ...
                {currentStep === 2 && (
                  <SizeStep
                    ...
                    onChange={(employeeCount) => setFormData((f) => ({ ...f, employeeCount: employeeCount as BusinessProfileForm['employeeCount'] }))}
                  />
                )}
                {currentStep === 3 && (
                  <EntityStep
                    value={formData.entityType}
                    onChange={(entityType) => setFormData((f) => ({ ...f, entityType: entityType as BusinessProfileForm['entityType'] }))}
                  />
                )}
                {currentStep === 4 && (
                  <ReviewStep
