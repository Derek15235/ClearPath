...
- [x] 01-03-PLAN.md — Design system UI components (Button, Card, Input, Modal, Skeleton, ErrorState, EmptyState, Badge, PageHeader)
...
Plans:
- [ ] 02-01-PLAN.md — Supabase client singleton, Zustand auth store, FastAPI backend scaffold with JWT middleware and health endpoint, Wave 0 test stubs
- [ ] 02-02-PLAN.md — AuthPage (card-swap state machine), RequireAuth route guard, AuthCallbackPage, UserProfileMenu logout, route wiring
