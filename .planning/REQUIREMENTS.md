...
- [x] **AUTH-03**: User can log in and receive a valid JWT session
...
- [x] **UI-04**: Consistent design system using Tailwind theme tokens (colors, spacing, typography)
- [x] **UI-05**: Page transitions and micro-interactions via framer-motion
- [x] **UI-06**: Loading skeletons and error states for all async data
